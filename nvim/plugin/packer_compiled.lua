...
_G.packer_plugins = {
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/editorconfig-vim",
  ...
  ["haskell-vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/haskell-vim",
  ...
  ["jellybeans.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/jellybeans.vim",
  ...
  ["nightfall.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/nightfall.vim",
    url = "https://github.com/alexparco/nightfall.vim"
  },
  ["nvim-cmp"] = {
    loaded = true,
