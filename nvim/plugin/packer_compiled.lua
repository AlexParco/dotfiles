...
_G.packer_plugins = {
  ...
  ["Spacegray.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/Spacegray.vim",
  ...
  minimalist = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/minimalist",
  ...
  ["vim-signature"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-signature",
